...
// setting up the gravity hazard function
function Lift(pos) {
    this.pos = pos;
    this.size = new Vector(1, 1);
}
...
// finish will behave and look similarly to a wall as it is a space to end the level on
function Finish(pos) {
    this.pos = pos;
    this.size = new Vector(1, 1);
...
// Jumper will be an interactive block the player can boost their jump on. It should have a horizontally moving variant tied to the ch "J". Emphasis on should
...
Level.prototype.playerTouched = function(type, actor) {
    ...
    if (type == "lava" && this.status == null) {
        ...
        //adding condition that coins must be collected and finish block mst be touched
